...
export const LoginbyEmail = () => {
    ...
    return (
        <Formik initialValues={{ email: "", password: "" }} validationSchema={loginSchema} onSubmit={(value, action) => {
            handleSubmit(value);
                ...
                return (
                    <Box as={Form}>
                        <Flex justifyContent={"center"}>
                            <VStack>
                                <Field as={Input} name="email" color={"black"} borderRadius={"20px"} border={"2px solid"} justifyContent={"center"} borderColor={"#408E91"} w={["190px", "200px", "230px", "300px", "370px"]} placeholder="Email" size={"md"} />
                                <ErrorMessage component="box" name="email" style={{ color: "red", marginBottom: "-18px", marginTop: "-8px" }} />
                            </VStack>
                        </Flex>
                        <Flex ml={{ base: '33px', md: '30px', lg: '30px' }} mt={"20px"} justifyContent={"center"}>
                            ...
                            <Button onClick={handleClick} right={["3px", "0px"]} variant={"unstyled"} mt={"3px"} size='sm'>
