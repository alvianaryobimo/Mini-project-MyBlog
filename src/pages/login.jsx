...
export const Login = () => {
    return (
        <Box display={"flex"} justifyContent={"center"} h={"100vh"} w={"full"} bgGradient="linear(#408E91, #71B280)">
            <Box rounded='md' boxShadow='0px 0px 10px black' bg={"white"} margin={"auto"} w={["250px", "280px", "300px", "400px", "450px", "500px"]} h={"420px"}>
